<template lang="pug">
  main
    picture-comp(
      ...
      fileName="main-bg"
      :imgSetSizes="$options.mainBgSizes"
      width="320"
      height="249"
      alt="дорожная развязка")
    section.intro
      .intro__title
        h1.container Узнаете ли вы Россию <span>по дорогам?</span>
      .intro__middle
        .container
          ...
          router-link(:to={name: "HalfExample", params: {question: 1}} class="btn-light-blue intro__run-test") Пройти тест!
</template>
